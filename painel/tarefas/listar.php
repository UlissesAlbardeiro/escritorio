...
echo <<<HTML
			<tr> 
				...
				<td>
					...
					<big><a href="#" onclick="mostrar('{$id}', '{$titulo}', '{$descricao}','{$hora}','{$data_formatada}','{$nome_usu}','{$status}','{$obs}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
