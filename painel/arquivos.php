			...
			<div class="modal-content">
				...
				<form id="form-arquivos" method="post">
					<div class="modal-body">
						...
						<div class="col-md-8">
							<div class="form-group">
								<select class="form-control selbusca" name="departamento" id="setor" style="width:100%;">
						...
						<div class="row" style="margin-top:-40px">
							<div class="col-md-8">
								<input type="text" class="form-control" name="nome"  id="nome" placeholder="Nome do Arquivo * " required>
							</div>
