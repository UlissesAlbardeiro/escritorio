...
//LANÇAR NAS MOVIMENTAÇÕES
	$pdo->query("INSERT INTO movimentacoes set tipo = 'Saída', movimento = 'Conta à Pagar', descricao = '$descricao', valor = '$valor_antigo', usuario = '$id_usuario', data = curDate(), lancamento = '$saida_antiga', id_mov = '$id'");
...
$titulo_not = 'Baixa Conta à Pagar ';
